...
public class Main extends PApplet {
    ...
    public void setup(){
        ...
        ArrayList<Drawable> panels = new ArrayList<Drawable>(NUM_PANELS_HORIZONTAL * NUM_PANELS_VERTICAL); //finding out how many panels you need
        ...
        for (int i = 0; i < NUM_PANELS_VERTICAL; i++){ // look at every panel in rows
            for (int j = 0; j < NUM_PANELS_HORIZONTAL; j++){ //look at every panel in columns
                ...
                panels.set(index,s); //making the panels that image
